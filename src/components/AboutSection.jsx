...
const values = [
  ...
  },
  {
    ...
    title: "Roast-To-Order Shipping",
    description:
      "We don't pre-roast and shelve. Your beans are roasted after you order and shipped withing 1-2 days. Free delivery on orders over $50."
  }
];
      ...
      <div className="about-story-grid">
        <ScrollReveal animation="fadeLeft" className="about-story-text">
          <p className="about-body lead--light">
            The Beans Place started in 2012 with one simple belief; coffee should be accessible to
            everyone- not just aficionados. We work directly with farming cooperative across four
            continents, paying above fair-trade prices to ensure quality from soil to sip.
          </p>

          <p className="about-body lead--light">
            Every week, our roastmaster cups dozens of samples to select only the lots that meet our
            standard. Whether you prefer a bright, fruity Ethiopian Yirgacheffe or a deep,
            chocolatey Colombian Supremo, we roast each batch to order so it arrives at peak
            freshness.
          </p>
        </ScrollReveal>
