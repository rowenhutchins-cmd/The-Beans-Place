    ...
    <div className="cta-section">
      ...
      <ScrollReveal animation="fadeUp" delay={0.2}>
        <p className="cta-subtitle">
          Skip the line. Order premium single-origin coffee online and get it roasted to order. From
          our roastery to your doorstep in 1-2 business days.
        </p>
      </ScrollReveal>
