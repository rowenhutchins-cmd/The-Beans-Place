...
import imgColumbianSupremo from "../assets/Colombian-Supremo-Bag.png";
...
const products = [
  ...
  },
  {
    ...
    origin: "Guatemala",
    price: "1 Free bag with subscription",
    roast: "Dark",
    ...
    <div className="product-shocase">
      ...
      <ScrollReveal animation="fadeUp" delay={0.15}>
        <p className="product-showcase-subtitle">
          Hand-selected single-origin coffees, roasted to order. Each bag ships within 48 hours of
